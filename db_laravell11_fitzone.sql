...
--
-- Base de datos: `db_laravell11_fitzone`
--
...
CREATE TABLE `clases` (
  ...
  `objetivo` varchar(255) DEFAULT 'Objetivo Pendiente',
...
(4, '2025_07_05_015408_create_usuarios_table', 1),
...
--
ALTER TABLE `pagos`
  ADD CONSTRAINT `pagos_usuario_id_foreign` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;
